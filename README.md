...
<head>
   ...
   <meta name="google-site-verification" content="google14cf721d2e296ad" />
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .whatsapp-btn { width: 50px; height: 50px; bottom: 20px; right: 20px; font-size: 25px; }
        }
    </style>
</head>
<body>
    ...
    <a href="https://wa.me/966559792737" class="whatsapp-btn" target="_blank" title="تواصل معنا عبر واتساب">
